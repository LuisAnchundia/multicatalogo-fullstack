...
import { leerCarrito } from '../services/cartStorage';
...
export const CartProvider = ({ children }: CartProviderProps) => {
  ...
  const [cart, setCart] = useState<CartItem[]>(() => user ? leerCarrito(storageKey) : []);
  ...
  useEffect(() => {
    try {
      ...
      // Mantiene operativo el carrito en memoria si el navegador bloquea el almacenamiento.
      console.warn('No se pudo persistir el carrito en este navegador.');
    }
  }, [cart, storageKey]);
